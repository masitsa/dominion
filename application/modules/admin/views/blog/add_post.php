						...
						<section class="panel">
							...
							<div class="panel-body">
                            	<div class="row" style="margin-bottom:20px;">
                                    <div class="col-md-12">
                                    	<a href="<?php echo site_url().'blog/posts';?>" class="btn btn-success pull-right">Back to posts</a>
                                    </div>
                                </div>
            <!-- Adding Errors -->
            <?php
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="post_video" class="form-control" value="<?php echo set_value('post_video');?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="post_audio" class="form-control" value="<?php echo set_value('post_audio');?>"/>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
