		...
		if ($query->num_rows() > 0)
		{
			...
			foreach ($query->result() as $row)
			{
				...
				'
					<tr>
						<td>'.$count.'</td>
						<td><img src="'.base_url()."assets/img/posts/thumbnail_".$image.'"></td>
						...
						<td>'.$comments.'</td>
						<td>'.$status.'</td>
						<td><a href="'.site_url().'edit-post/'.$post_id.'" class="btn btn-sm btn-primary">Edit</a></td>
						...
						<section class="panel">
							...
							<div class="panel-body">
                            	<div class="row" style="margin-bottom:20px;">
                                    <div class="col-lg-12">
                                    	<a href="<?php echo site_url().'add-post';?>" class="btn btn-success pull-right">Add post</a>
                                    </div>
                                </div>
