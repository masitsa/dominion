			...
			<table class="table table-bordered table-striped table-condensed">
				<thead>
					<tr>
						<th>#</th>
						<th>Image</th>
						<th><a href="'.site_url().'products/categories/category_name/'.$order_method.'/'.$page.'">Category name</a></th>
						<th><a href="'.site_url().'products/categories/category_parent/'.$order_method.'/'.$page.'">Category parent</a></th>
						<th><a href="'.site_url().'products/categories/created/'.$order_method.'/'.$page.'">Date Created</a></th>
						<th><a href="'.site_url().'products/categories/last_modified/'.$order_method.'/'.$page.'">Last modified</a></th>
						<th><a href="'.site_url().'products/categories/category_status/'.$order_method.'/'.$page.'">Status</a></th>
