                            	...
                            	<div class="row">
                                	<div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" data-plugin-datepicker="" name="event_start_date" placeholder="Event start date" value="<?php echo date('Y-m-d',strtotime($event_row->event_start_time));?>">
                                        </div>
                                	</div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" data-plugin-options="{ &quot;showMeridian&quot;: false }" class="form-control" data-plugin-timepicker="" name="event_start_time" placeholder="Event start time" value="<?php echo date('H:I',strtotime($event_row->event_start_time));?>">
                                        </div>
                                	</div>
                               </div>
                            </div>
                            	...
                            	<div class="row">
                                	<div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" data-plugin-datepicker="" name="event_end_date" placeholder="Event end date" value="<?php echo date('Y-m-d',strtotime($event_row->event_end_time));?>">
                                        </div>
                                	</div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" data-plugin-options="{ &quot;showMeridian&quot;: false }" class="form-control" data-plugin-timepicker="" name="event_end_time" placeholder="Event end time" value="<?php echo date('H:I',strtotime($event_row->event_end_time));?>">
                                        </div>
                                	</div>
                               </div>
                            </div>
                ...
                <div class="row">
                	<div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                            	<textarea class="cleditor" name="event_description"><?php echo $event_row->event_description;?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
