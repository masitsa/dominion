								...
								if(!empty($email_error))
								{
                                    ...
                                    <div class="form-group mb-lg has-error">
                                        ...
                                        <div class="input-group input-group-icon">
                                            <input name="user_email" type="text" class="form-control input-lg" value="<?php echo $user_email;?>" />
                                            <label for="user_email" class="error"><?php echo $email_error;?></label>
								...
								if(!empty($user_password_error))
								{
                                    ...
                                    <div class="form-group mb-lg has-error">
                                        ...
                                        <div class="input-group input-group-icon">
                                            ...
                                            <label for="user_password" class="error"><?php echo $email_error;?></label>
                                            <span class="input-group-addon">
                                                <span class="icon icon-lg">
